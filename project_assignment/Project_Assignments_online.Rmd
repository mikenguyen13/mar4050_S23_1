...
**(1)** Completed [Team Orientation Assignment](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/Team%20Orientation.docx).

**(2)** Your group's first, second, and third choices for a project topic, from the "[Project Topics](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/Project_Topics.pdf)". You may also propose a topic of your own. If you wish to propose a topic, provide some details so your instructor can evaluate whether the proposed project would work for this class.
...
This assignment requires meeting with the professor. See the [signup sheet](https://docs.google.com/spreadsheets/d/1l5aTXjwT1In9-JY3LncuU5Voun1nCmS7gunQLs6r-lI/edit?usp=sharing).

This PA is highly similar to our [first case discussion](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/case_discussion/CE1%20%20discussion.docx).
...
The form of research questions will be discussed in class. You can also look at example term projects ([1](https://github.com/mikenguyen13/mar4050_S23_1/blob/main/project_assignment/written_report/example1%20SlideDoc%20research%20report.pdf),[2](https://github.com/mikenguyen13/mar4050_S23_1/blob/main/project_assignment/written_report/example2%20SlideDoc%20research%20report.pdf)) to see examples of research questions. Some important points to remember are below.

-   Research questions are [not]{.underline} the same as questionnaire questions. Questionnaire questions are what you ask the consumer on a survey. Research questions are the questions the **manager** wants to answer. Review lecture and [Case Discussion 1](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/case_discussion/CE1%20%20discussion.docx) to make sure your research questions are phrased appropriately. They should [not]{.underline} include any second person pronouns.
...
Note this assignment requires meeting with the professor and your team members. See the [signup sheet](https://docs.google.com/spreadsheets/d/1l5aTXjwT1In9-JY3LncuU5Voun1nCmS7gunQLs6r-lI/edit?usp=sharing).

The questionnaire is one of the most important parts of the project.

Example questionnaires are [available](https://github.com/mikenguyen13/mar4050_S23_1/tree/main/project_assignment/questionnaire/example_questionaire)

You can consult these examples for reference regarding ideas about question wording and format and questionnaire layout. Be sure to also look at [Questionnaire Tips](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/questionnaire/Questionnaire%20Design%20Cheat%20sheet.docx).
...
4.  a completed copy of Questionnaire Worksheet A ([WorksheetA template](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/questionnaire/8-Qnaire%20worksheet%20A.xls))

5.  a completed copy of Questionnaire Worksheet B ([WorksheetB template](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/questionnaire/8-Qnaire%20worksheet%20B.xls))
...
Type the data analysis plan for your project that you develop in class into a formal document, using the [Data Analysis Plan template](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/Data%20Anal%20Plan%20wkst.xlsx) and the [template](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/data%20analysis%20plan%20grid.xlsx). [Include at least one group comparison analysis in your data analysis plan]{.underline}. You can use this [Qualtrics guide](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/differences%20RQ%20analysis%20on%20Qualtrics.docx) for the group comparison research questions. You don't need to do the analysis yet, you only need to plan for the analysis.
...
In this assignment, you will evaluate your own performance throughout the project and that of other members of your group on the major project assignments completed so far. Click this [link](https://missouri.qualtrics.com/jfe/form/SV_6L3arPHAhgz84No) to complete your evaluation. This evaluation will be used to calculate 1/3 of the weight for your final report score, which means you can still have a chance to work hard and make up the work to earn a higher grade.
...
1.  You can use this [Qualtrics guide](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/differences%20RQ%20analysis%20on%20Qualtrics.docx) for the difference research questions.

2.  You can use the lecture slides on [Descriptive Statistics](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/lectures/9/1_Descriptive%20Statistics.pptx), and [Data Analysis Plan](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/lectures/9/2_Data%20Analysis%20Plan.pptx), and worksheets on [cross-tab](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/lectures/9/Cross-tab%20worksheet.xlsx) and [descriptive](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/lectures/9/descriptive.xlsx) for the difference questions bar-charts and other statistics.

3.  You can use the [excel cheat sheet](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/regression%20materials/2-Excel%20help%20sheet.docx) when you do the actual analysis.

4.  You can consult the [level of measurement common issues](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/lectures/Common%20issue%20level%20of%20measurement.docx) for your revision on the level of measurement.

5.  You **should** consult the Sample student projects ([1](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/written_report/example1%20SlideDoc%20research%20report.pdf), [2](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/written_report/example2%20SlideDoc%20research%20report.pdf)) for their **result section** on the **expected PA outputs**. The analysis report is organized by research question and should include the following:
...
-   The presentation of your term project should cover the topics described on the [Pointers on Presentations](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/presentation/Pointers%20on%20presentations.docx).
...
-   While preparing the presentation, carefully read and follow the Pointers on Presentations and review [the slides design tips](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/presentation/Presentation%20slide%20examples.pptx) and the [sample student presentation slides](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/presentation/Sample%20Student%20Presentation%20from%20previous%20semester.pptx) for reference.
...
-   Your presentation will be graded on the criteria described in the "[Presentation Evaluation Form](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/presentation/Presentation%20Evaluation%20Assignment.docx)."
...
Step 1: Familiarize yourself with the details of the critique assignment as described in the "[Presentation Evaluation Form](https://github.com/mikenguyen13/mar4050_S23_1/blob/main/project_assignment/presentation/Presentation%20Evaluation%20Assignment.pdf)".

Step 2: All teams that are not presenting are required to submit their evaluation (1 evaluation per team for a presenting group). To submit your presentation critique, please fill out [this Qualtrics survey](https://missouri.qualtrics.com/jfe/form/SV_9mlGh8Hm1ChP5xI) after each presentation (you can submit the survey multiple times)
...
Sample student projects ([1](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/written_report/example1%20SlideDoc%20research%20report.pdf), [2](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/written_report/example2%20SlideDoc%20research%20report.pdf)) are available. [Report format](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/written_report/Slidedocs%20report%20templates.pptx) and other guidelines are covered in class. See also the material titled "[Project Report Guidelines](https://github.com/mikenguyen13/mar4050_S23_1/raw/main/project_assignment/written_report/Project%20Report%20Guideline.pdf)".
...
In this assignment, you will evaluate your own performance throughout the project and that of other members of your group on the major project assignments completed so far. Click this [link](https://missouri.qualtrics.com/jfe/form/SV_3rNx7MghxRYEuSa) to complete your evaluation.
